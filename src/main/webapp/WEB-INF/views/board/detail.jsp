		            ...
		            <label>첨부파일</label>
							...
							<c:choose>
								<c:when test="${ attachment ne null }">
									<!--  다운로드 / 이미지면 미리보기 -->
									<img src="${ attachment.filePath }/${attachment.changeName}" style="width: 200px; hight=200px"/>
						...
						<th>댓글작성</th>
							...
							<c:choose >
								<c:when test="${ userInfo ne null }">
									<td>
										<textarea id="replyContent" cols="50" rows="3" style="resize:none;" class="form-control">as.</textarea>
									</td>
