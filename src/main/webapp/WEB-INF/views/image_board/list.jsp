...
<body>
	...
	<div class="outer">
		...
		<div
			style="margin-top: 15px; width: 400px; height: 280px; margin: auto;">
			<img width="100%" height="100%"
				src="https://kh-academy.co.kr/resources/images/main/logo.svg" alt="">
		</div>

		<div style="align: right;">
			<a class="btn btn-sm btn-primary"
				style="background: rgb(193, 229, 255); border: none; width: 100%"
				href="http://localhost:8088/kh/insert-form.im">글작성</a>
		</div>
