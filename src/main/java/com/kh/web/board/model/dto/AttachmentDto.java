...
public class AttachmentDto {
	...
	public String toString() {
		return "AttachmentDto [boardType=" + boardType + ", changeName=" + changeName + ", createDate=" + createDate
				+ ", fileLevel=" + fileLevel + ", fileNo=" + fileNo + ", filePath=" + filePath + ", originName="
				+ originName + ", refBno=" + refBno + "]";
	}
